...
lazy_static! {
    ...
    pub static ref TOKEN_MANAGER_CONTRACT: Address =  Address::from_str("0000000000000000000000000000000000001008").unwrap();
    pub static ref CROSS_CHAIN_CONTRACT: Address =  Address::from_str("0000000000000000000000000000000000002000").unwrap();
...
mod tests {
    ...
    fn test_bsc_sign_block() {
        ...
        assert_eq!(
            addr,
            Address::from_str("217812Db806b663F91a14544dcAc87e382b54B52").unwrap()
        );
    }
